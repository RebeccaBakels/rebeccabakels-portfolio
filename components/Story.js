  ...
  return (
    <>
      ...
      <p className={styles.paragraph}>
        ...
        impact it had on my mental health. Feeling pushed to the absolute edge I
        put in my two weeks and made the decision to utilize all that energy
        into something that would challenge and grow with me.
      </p>
      <br />
      <p className={styles.paragraph}>
        My sister, Michelle Bakels, a former Gallery Director and Art-History
        Major turned software developer, inspired me to make the switch to tech.
        I saw how happy she was and I couldn't remember the last time I could
      ...
      <p className={styles.paragraph}>
        ...
        completing these courses, I took a 10-week Software Engineering bootcamp
        that was mentally challenging but immensely rewarding. It was a mental
        hurdle to believe I am capable of learning these things, to be
        comfortable with the unknown and understand how to find the right
      ...
      <br />
      <p className={styles.paragraph}>
        This is where my support system was key. I had my person, my sister, to
        talk to in those low moments when I thought I really couldn't make it
        through. She heard me out, sympathize with my struggle, gave me the
        ...
        much as I did at my previous job and having my weekends and holidays to
        enjoy my life.
      </p>
      <br />
      <p className={styles.paragraph}>
